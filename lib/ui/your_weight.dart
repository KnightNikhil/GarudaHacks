            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  child: Center(child: Text('Weight Class',style: TextStyle(color: Colors.white,fontSize: 25.0,fontWeight: FontWeight.w500),)),
              ),
                ...
                child: Row(
                  ...
                  children: [
                    GestureDetector(
                        ...
                        child: Text('Kg',style: TextStyle(fontSize: 20.0,decoration:(bmical.isweight)?TextDecoration.underline:null),)
                    ),
                    SizedBox(width: 20.0,),
                    ...
                    GestureDetector(
                        ...
                        child: Text('lbs',style: TextStyle(fontSize: 20.0,decoration:(bmical.isweight)?null:TextDecoration.underline ),)
                    )
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    IconButton(
                        icon: Icon(Icons.calendar_today,size: 25.0,color: Colors.orange,),
                      onPressed:  () {
                        showDatePicker(
                            context: context,
                    ...
                    Text(dob,style: TextStyle(fontSize: 15,color: Colors.black,fontWeight: FontWeight.w400),),
                  ],
                ),
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.chevron_right,color: Colors.white,size: 80.0,),
                ),
              ),
